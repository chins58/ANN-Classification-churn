...
geo_encoded_df = pd.DataFrame(geo_encoded, columns=lable_encoder_geo.get_feature_names_out())
...
prediction_proba= predication[0][0]
...
if prediction_proba >0.5:
    ...
    st.write('The Customer is not likedly to churn')
